    ...
    <div className='App'>
      <div>
        ...
        <p className='text-content'>
          ...
          of Boids, as well as to brush up on some of my programming & trigonometry skills :) If you
          like this, feel free to check out some of my other work at my website:
          <br />
